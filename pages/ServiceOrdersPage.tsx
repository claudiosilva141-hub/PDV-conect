...
import { Edit, Eye, Printer, MessageSquareText, Plus, Factory, Trash2 } from 'lucide-react';
import { Modal } from '../components/Modal';
import { generateWhatsAppInvoiceLink } from '../utils/whatsappLinkGenerator';
import { EditOrderModal } from './EditOrderModal';

export const ServiceOrdersPage: React.FC = () => {
  const { orders, updateOrder, addOrder, deleteOrder, companyInfo, products, clients, addClient, updateClient, rawMaterials, checkPermission } = useAuth(); // Use checkPermission
  ...
  const handleSaveOrder = async (orderToSave: Order) => {
    ...
    try {
      ...
      alert('Erro ao salvar a ordem de serviço. Verifique os dados e tente novamente.');
    }
  };
                  ...
                  <tr key={order.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      ...
                      <Button
                        ...
                        disabled={!canEditServiceOrder} // Re-using edit permission for delete or could use a new one
                      >
                        Excluir
                      </Button>
                    </td>
