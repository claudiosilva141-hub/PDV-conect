export interface CompanyInfo {
  key?: string; // Used by Dexie for singleton tables (optional in frontend when using API)
  name: string;
...
export interface AuthContextType {
  ...
  registerUser: (username: string, password: string, role: UserRole) => Promise<void>; // New: Register a new user
  updateUser: (user: User) => Promise<void>; // New: Update existing user
  deleteUser: (id: string) => Promise<void>; // New: Delete user
  updateUserPermissions: (permissions: UserPermissions) => Promise<void>; // New: Update configurable permissions
